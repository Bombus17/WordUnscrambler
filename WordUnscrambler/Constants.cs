...
namespace WordUnscrambler
{
    class Constants
    {
        ...
        public const string EnterWordsViaFile = "Enter full path including the file name: ";
        public const string EnterWordsManually = "Enter words manually (separated by commas):";
